...
removesites<- rbind(data.frame(site_no = pipelines$site_no), data.frame(site_no =lakes$site_no), data.frame(site_no =res_2kbuff$site_no), data.frame(site_no = unique(dams2$site_no)))%>% distinct()
